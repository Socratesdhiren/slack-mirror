export const API_URL = `${process.env.REACT_APP_REST_API_HOST}/v1`;
export const PERMISSION_KEY = 'finpulse-permissions';
export const MENU_KEY = 'finpulse-menus';
export const JWT_TOKEN = 'finpulse-token';
export const LOGGED_IN_USER = 'finpulse-user';
export const USER_FULL_NAME = 'finpulse-fullName';
export const LANGUAGE_KEY = 'finpulse-language';
